...
bm25_index = None        # Cache BM25 index


def init_corpus_and_bm25():
    """
    Khởi tạo CORPUS và BM25 index nếu chưa được dựng.
    """
...
if __name__ == "__main__":
    import sys
    # Configure stdout to use UTF-8 encoding to support Vietnamese characters on Windows console
